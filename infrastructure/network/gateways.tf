...
resource "aws_api_gateway_resource" "upload_data_s3_trigger" {
...
resource "aws_api_gateway_method" "upload_data_s3_trigger_method" {
  rest_api_id   = aws_api_gateway_rest_api.api.id
  resource_id   = aws_api_gateway_resource.upload_data_s3_trigger.id
  http_method   = "POST"
  authorization = "CUSTOM"
  authorizer_id = aws_api_gateway_authorizer.kpi_authorizer.id
}
...
resource "aws_api_gateway_integration" "upload_data_s3_trigger_integration" {
  rest_api_id             = aws_api_gateway_rest_api.api.id
  resource_id             = aws_api_gateway_resource.upload_data_s3_trigger.id
  http_method             = aws_api_gateway_method.upload_data_s3_trigger_method.http_method
  integration_http_method = "POST"
  type                    = "AWS_PROXY"
  uri                     = var.lambdas_functions_arn.upload_data_s3_trigger_lambda_function
}
# ----------------------------------------------------------------------------------------------------------------------
# API GATEWAY DOMAIN
