...
resource "aws_s3_bucket_object" "get_companies_kpi_average_function_object" {
  bucket = var.bucket_name
  key = "${var.lambda_resource_name}/${var.environment}/get_companies_kpi_average_handler.zip"
  source = "${path.module}/../../dist/get_companies_kpi_average_handler.zip"
  etag = filemd5("${path.module}/../../dist/get_companies_kpi_average_handler.zip")
}

resource "aws_s3_bucket_object" "get_companies_count_by_size_function_object" {
  bucket = var.bucket_name
  key = "${var.lambda_resource_name}/${var.environment}/get_companies_count_by_size_handler.zip"
  source = "${path.module}/../../dist/get_companies_count_by_size_handler.zip"
  etag = filemd5("${path.module}/../../dist/get_companies_count_by_size_handler.zip")
}
...
resource "aws_s3_bucket_object" "get_expected_growth_and_margin_function_object" {
  bucket = var.bucket_name
  key = "${var.lambda_resource_name}/${var.environment}/get_expected_growth_and_margin_hanlder.zip"
  source = "${path.module}/../../dist/get_expected_growth_and_margin_hanlder.zip"
  etag = filemd5("${path.module}/../../dist/get_expected_growth_and_margin_hanlder.zip")
}
resource "aws_s3_bucket_object" "get_revenue_and_ebitda_function_object" {
  bucket = var.bucket_name
  key = "${var.lambda_resource_name}/${var.environment}/get_revenue_and_ebitda_handler.zip"
