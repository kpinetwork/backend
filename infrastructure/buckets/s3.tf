...
resource "aws_s3_bucket_object" "get_metric_by_id_function_object" {
  bucket = var.bucket_name
  key = "${var.lambda_resource_name}/${var.environment}/get_metric_by_id_handler.zip"
  source = "${path.module}/../../dist/get_metric_by_id_handler.zip"
  etag = filemd5("${path.module}/../../dist/get_metric_by_id_handler.zip")
}
