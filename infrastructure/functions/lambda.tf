...
resource "aws_lambda_function" "get_companies_kpi_average_lambda_function" {
  role             = var.lambdas_exec_roles_arn.companies_kpi_average_exec_role_arn
  handler          = "get_companies_kpi_average_handler.handler"
  runtime          = var.runtime
  s3_bucket        = var.object_bucket_references.get_companies_kpi_average_function_bucket.bucket
  s3_key           = var.object_bucket_references.get_companies_kpi_average_function_bucket.key
  function_name    = "${var.environment}_${var.lambdas_names.get_companies_kpi_average_lambda_function}"
  source_code_hash = base64sha256(var.object_bucket_references.get_companies_kpi_average_function_bucket.etag)
...
resource "aws_lambda_function" "get_companies_count_by_size_lambda_function" {
  role             = var.lambdas_exec_roles_arn.companies_count_by_size_exec_role_arn
  handler          = "get_companies_count_by_size_handler.handler"
  runtime          = var.runtime
  s3_bucket        = var.object_bucket_references.get_companies_count_by_size_function_bucket.bucket
  s3_key           = var.object_bucket_references.get_companies_count_by_size_function_bucket.key
  function_name    = "${var.environment}_${var.lambdas_names.get_companies_count_by_size_lambda_function}"
  source_code_hash = base64sha256(var.object_bucket_references.get_companies_count_by_size_function_bucket.etag)
...
resource "aws_lambda_function" "get_growth_and_margin_lambda_function" {
  role = var.lambdas_exec_roles_arn.get_growth_and_margin_exec_role_arn
  handler = "get_growth_and_margin_handler.handler"
  runtime = var.runtime
  s3_bucket = var.object_bucket_references.get_growth_and_margin_function_bucket.bucket
  s3_key = var.object_bucket_references.get_growth_and_margin_function_bucket.key
  function_name = "${var.environment}_${var.lambdas_names.get_growth_and_margin_lambda_function}"
  source_code_hash = base64sha256(var.object_bucket_references.get_growth_and_margin_function_bucket.etag)
...
resource "aws_lambda_function" "get_expected_growth_and_margin_lambda_function" {
  role = var.lambdas_exec_roles_arn.get_expected_growth_and_margin_exec_role_arn
  handler = "get_expected_growth_and_margin_handler.handler"
  runtime = var.runtime
  s3_bucket = var.object_bucket_references.get_expected_growth_and_margin_function_bucket.bucket
