...
class TestGetUniverseOverviewHandler(TestCase):
    ...
    @mock.patch(
        "universe_overview.get_universe_overview_handler.get_username_from_user_id"
    )
    @mock.patch("company_anonymization.CompanyAnonymization.set_company_permissions")
    @mock.patch(
        "universe_overview.get_universe_overview_handler.get_user_details_service_instance"
    )
    @mock.patch("universe_overview.get_universe_overview_handler.verify_user_access")
