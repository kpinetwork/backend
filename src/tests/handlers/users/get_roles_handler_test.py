...
import src.handlers.users.get_roles_handler as roles_handler
...
class TestGetRolesHandler(TestCase):
    ...
    @mock.patch.object(roles_handler, "verify_user_access")
    ...
    def test_get_users_handler_fail_no_access_400_response(
        ...
        error_message = "No permissions to get roles"
