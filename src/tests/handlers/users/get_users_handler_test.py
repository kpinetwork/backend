...
import src.handlers.users.get_users_handler as users_handler
...
class TestGetUsersHandler(TestCase):
    ...
    @mock.patch.object(users_handler, "verify_user_access")
    ...
    def test_get_users_handler_fail_no_access_400_response(
        ...
        error_message = "No permissions to get users"
