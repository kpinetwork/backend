...
class TestAssignUserCompanyPermissionsHandler(TestCase):
    ...
    @mock.patch.object(assign_permissions_handler, "verify_user_access")
    def test_assign_user_company_permissions_handler_success_should_return_200_response(
        ...
        mock_assign_company_permissions,
    ):
    ...
    @mock.patch.object(assign_permissions_handler, "get_user_details_service_instance")
    @mock.patch.object(assign_permissions_handler, "verify_user_access")
    def test_assign_user_company_permissions_handler_without_access_should_return_400_response(
        self,
        mock_verify_user_access,
        mock_get_user_service_instance,
        mock_assign_company_permissions,
    ):
        error_message = "No permissions to assign company permissions"
